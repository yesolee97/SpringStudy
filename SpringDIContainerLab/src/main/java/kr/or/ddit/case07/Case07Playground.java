...
import kr.or.ddit.case07.conf.Case07ResouceLoadingConfig;
...
public class Case07Playground {
	public static void main(String[] args) throws IOException {
		ConfigurableApplicationContext context = new AnnotationConfigApplicationContext(Case07ResouceLoadingConfig.class);
...
//		copyResource2(cR, dest);
	...
	private static void moveResource(Resource fR, WritableResource dest) throws IOException {
		copyResource2(fR, dest);	// 복
		File wrappedFile = fR.getFile();
		wrappedFile.delete();
	}
